...
public class ReportController {
    ...
    public Result getMemberReport(){
        ...
        List<Integer> membercount = memberService.getMemberCountByMonths(months);
    ...
    public Result getSetmealReport(){
        ...
        Map map = new HashMap();
        List<Map> setmealCount = setmealService.getSetmealCountNames();
    ...
    public Result getBusinessReportData(){
        Map map = businessService.getBusinessReportData();
    ...
    public Result exportBusinessReport(HttpServletRequest request, HttpServletResponse response){
        ...
        try {
            Map<String, Object> result = businessService.getBusinessReportData();
