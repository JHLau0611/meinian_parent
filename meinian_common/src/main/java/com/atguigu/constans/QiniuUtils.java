...
public class QiniuUtils {
    ...
    public  static String accessKey = "USEkoOZeQytjGVH2tPqKWLe8T_8AfSXuGPBM-HJI";
    public  static String secretKey = "fdNjyp8q0BEICJLBSmibsOhz2hgiqXk4Oe3SlMS2";
    public  static String bucket = "0526jhl";
